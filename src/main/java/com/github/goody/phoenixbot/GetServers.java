...
import com.github.goody.phoenixbot.pterodactylwarpper.Servers;
...
public class GetServers {
    ...
    public static String[] getNetworkInfo(MessageCreateEvent event) {
        ...
        try {
            ...
            for(Server emp : emps.getServers())
            {
                ...
                MinecraftServer qserver = new MinecraftServer(emp.getNumIP(),emp.getPort());
                ...
                count++;
                    ...
                    if(!Botstate.getStateIgnOffline()) {
                        ...
                        Util.BuildServerRestart(event, emp.getID());
